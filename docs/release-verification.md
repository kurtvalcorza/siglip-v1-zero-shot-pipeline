...
|---|---|---|---|---|---|
| 2026-09-20 | `cb34e57` / `bd4b3cba` | Kaggle Tesla T4 (`kurtvalcorza/dimer-nb2-siglip-v1-zero-shot` v1; image `torch 2.10.0+cu128` / `transformers 5.0.0` before the pinned install, `torch 2.14.0+cu130`, `transformers 4.57.6` after, Python 3.12.13, `cuda`) | Default sample path, `Run all` from a fresh interpreter with an empty Hugging Face cache and no repository checkout (blob SHA-1 verified against GitHub before execution) — the notebook's first execution anywhere and this repository's first GPU run | 455.3 s | **PASSED** — 14/14 code cells ok (1 restart after install cell); 378 files, 855 MB staged from the Hub into a clean cache; comparison {accuracy: {majority: 0.167, neighbour: 0.26, frozen: 0.76, adapted: 0.844}, macro_f1: {majority: 0.048, neighbour: 0.261, frozen: 0.761, adapted: 0.847}, t2i_map: {majority: 0.203, neighbour: 0.212, frozen: 0.718, adapted: 0.891}, delta_vs_frozen: {accuracy: 0.083, macro_f1: 0.086, t2i_map: 0.172}, scientific_name_prompts: {accuracy: {frozen: 0.542, adapted: 0.562}, macro_f1: {frozen: 0.53, adapted: 0.536}, t2i_map: {frozen: 0.536, adapted: 0.618}}, by_species: {american_goldfinch: {n: 16, frozen_recall: 0.94, adapted_recall: 0.94, frozen_ap: 0.91, adapted_ap: 0.99}, chipping_sparrow: {n: 16, frozen_recall: 0.44, adapted_recall: 0.69, frozen_ap: 0.68, adapted_ap: 0.82}, dark_eyed_junco: {n: 16, frozen_recall: 0.81, adapted_recall: 0.88, frozen_ap: 0.84, adapted_ap: 0.9}, house_finch: {n: 16, frozen_recall: 0.81, adapted_recall: 0.88, frozen_ap: 0.83, adapted_ap: 0.97}, song_sparrow: {n: 16, frozen_recall: 0.75, adapted_recall: 0.94, frozen_ap: 0.72, adapted_ap: 0.8}, white_throated_sparrow: {n: 16, frozen_recall: 0.81, adapted_recall: 0.75, frozen_ap: 0.34, adapted_ap: 0.87}}}; reload parity {max_abs_difference: 0.0, identical_rows: 8, of: 8}; run summary and executed notebook archived under `.agent/backups/kaggle-e2e-2026-09-19/out/dimer-nb2-siglip-v1-zero-shot/v1/evidence/` in the workspace |
