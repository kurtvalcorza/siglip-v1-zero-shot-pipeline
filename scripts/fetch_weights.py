#!/usr/bin/env python
"""Download and verify base-model weights for the SigLIP vision-language pipeline.

Downloads and verifies the pinned Hugging Face SigLIP checkpoint
...
Usage:
    ...
    # Download default model (siglip-base-patch16-256) into weights/siglip-base-patch16-256/:
...
from siglip_v1_pipeline.config import (  # noqa: E402
    DEFAULT_MODEL_KEY,
    MODEL_FILENAME,
    MODEL_ID,
    MODEL_REVISION,
...
def fetch_model(
    ...
    """Download and verify the SigLIP model checkpoint."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Download and verify base-model weights for SigLIP pipeline."
    )
    parser.add_argument(
        "--dest",
        type=Path,
