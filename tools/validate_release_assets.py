"""Static release-asset validation for the SigLIP v1 zero-shot (E2E) DIMER pipeline.
...
EXPECTED_MODEL_ID = "google/siglip-base-patch16-256"
...
EXPECTED_OUTPUTS = (
    "outputs/siglip_v1_zero_shot_train.csv",
    "outputs/siglip_v1_zero_shot_input_manifest.json",
    "outputs/siglip_v1_zero_shot_evaluation_report.json",
    "outputs/siglip_v1_zero_shot_shapes.json",
    "outputs/siglip_v1_zero_shot_adapter",
    "outputs/siglip_v1_zero_shot_result.json",
...
CODE_MARKERS = (
    ...
    "write_dataset_csv(train_records, 'outputs/siglip_v1_zero_shot_train.csv')",
...
EXTERNAL_WEIGHT_BYTES: dict[int, str] = {
    85_062_712: "SigLIP fine-tune adapter.safetensors, 2 blocks, from the tutorial run (45 tensors)",
}
