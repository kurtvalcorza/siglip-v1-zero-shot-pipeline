...
def resolve_weights_path(
    ...
    2. Environment variable `SIGLIP_V1_WEIGHTS_DIR` -> 'env_var'
    3. Source checkout convention `weights/siglip-base-patch16-256` -> 'repo_offline'
    ...
    env_dir = os.environ.get("SIGLIP_V1_WEIGHTS_DIR")
    if env_dir:
...
def load_components(
    *,
    ...
    """Acquire, verify, and load the one supported SigLIP checkpoint."""
